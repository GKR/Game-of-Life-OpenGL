...
int main(int argc, char** argv) { 
  ...
  shared_ptr<Texture> textureLogo(new Texture("../textures/game-of-life.bmp", true));
  ...
  do {
    ...
    // --- RENDER TO SCREEN PASS ---
    {
      ...
      { // Draw logo
        ...
        glUniform2f(passthroughWindowSizeLocation, windowWidth, windowHeight);
        glUniform1f(passthroughTimeLocation, (float)(glfwGetTime() * 10.0f));
        glUniform3f(passthroughScaleLocation, 0.2f, 0.2f, 1.0f);
        glUniform3f(passthroughTranslateLocation, 0.78f, 0.76f, 0.0f);
